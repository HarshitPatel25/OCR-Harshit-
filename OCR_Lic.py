# -*- coding: utf-8 -*-
"""
Created on Fri Jul 31 13:20:43 2020
...
from stack.widgets import rect2Box, shoWait, validDateString
...
def readRois(rois, meanAngle, stdAngle):
  ...
  for i in sorted (rois.keys()):
    ...
    text_origin = pt.image_to_string(origin)
    text_gray = pt.image_to_string(gray)
